...
// import zaid1Img from '../../assets/img/zaid1.jpeg';


export function PageZaidimaiItem() {
            ...
            <section className="container px-4 ms-2">
                <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
                    <div className="col-10 col-sm-8 col-lg-6">
                        <img src={<></>} className="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="320" height="600" loading="lazy" />
                    </div>
